...
- (void)setMenuMonthsView:(JTCalendarMenuView *)menuMonthsView
{
    ...
    self.menuMonthsView.frame = CGRectMake(0, 0, menuMonthsView.frame.size.width, 45);
    self.menuMonthsView.contentMode = UIViewContentModeScaleToFill;
...
- (void)setContentView:(JTCalendarContentView *)contentView
{
    ...
    self.contentView.frame = CGRectMake(0, 36, _menuMonthsView.frame.size.width, 270);
