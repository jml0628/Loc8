...
- (void)configureConstraintsForSubviews
{
    ...
    circleView.frame = CGRectMake(0, 0, 33, 33);
//    circleView.color = [UIColor colorWithRed:(176.0/255.0) green:(176.0/255.0) blue:(176.0/255.0) alpha:1];
...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated
{
    ...
    UIColor *curMonthColor = [UIColor colorWithRed:(176.0/255.0) green:(176.0/255.0) blue:(176.0/255.0) alpha:1];;
    
    if(selected){
        if(!self.isOtherMonth){
            circleView.color = [UIColor colorWithRed:(127.0/255.0) green:(213.0/255.0) blue:(193.0/255.0) alpha:1];
        ...
        if(!self.isOtherMonth){
            textLabel.textColor = curMonthColor;
