...
#import "GoMessageViewController.h"
...
@interface GoMessageViewController ()

@end

@implementation GoMessageViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    int pubLevelx = (int) indexPath.row % 2;
        ...
        [cell.ItemImg1 setImage:[UIImage imageNamed: @"photo1.png"]];
        [cell.ItemImg2 setImage:[UIImage imageNamed: @"iconTime.png"]];
